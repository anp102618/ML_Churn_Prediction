...
ordinal_encoder = joblib.load("./Fast_API/preprocessors/ordinal_encoder.joblib")
ohe_encoder = joblib.load("./Fast_API/preprocessors/ohe_encoder.joblib")
scaler = joblib.load("./Fast_API/preprocessors/scaler.joblib")
