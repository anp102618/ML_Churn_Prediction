...
ordinal_encoder = joblib.load("./FastAPI/preprocessors/ordinal_encoder.joblib")
ohe_encoder = joblib.load("./FastAPI/preprocessors/ohe_encoder.joblib")
scaler = joblib.load("./FastAPI/preprocessors/scaler.joblib")
